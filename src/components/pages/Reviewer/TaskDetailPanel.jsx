      ...
      <div className="p-5 space-y-5">
        ...
        <div className="rounded-2xl border border-slate-700 bg-[#0f172a]/40 p-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <span
              className={`text-xs font-bold px-2.5 py-1 rounded-full border ${allQcChecked
        ...
        <div className="rounded-2xl border border-slate-700 bg-[#0f172a]/40 p-4">
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
            ...
            <button
              ...
              disabled={selectedTask.status !== 'pending' || quotaReached}
              className={`flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-2xl text-sm font-black text-white transition-all shadow-lg disabled:opacity-40 disabled:cursor-not-allowed ${rejectMode ? 'bg-rose-600 hover:bg-rose-500 shadow-rose-500/20' : 'bg-red-600 hover:bg-red-500 shadow-red-500/20'
                }`}
            >
              <ThumbsDown size={18} />
