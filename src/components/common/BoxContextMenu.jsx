// Đường dẫn: src/components/BoxContextMenu.jsx
  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="bg-slate-800 text-white text-sm rounded px-2 py-2 outline-none border border-slate-600 cursor-pointer"
      >
      ...
      <button
        ...
        className="flex items-center justify-center gap-1.5 w-full bg-red-500/10 hover:bg-red-500 text-red-400 hover:text-white py-2 rounded text-sm transition-all border border-red-500/20 mt-1"
      >
